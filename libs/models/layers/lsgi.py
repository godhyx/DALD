...
from .msdeform import ModifyMultiScaleDeformableAttention


@ATTENTION.register_module()
class lsgi_roi(nn.Module):
    '''
    ...
    def __init__(self, fc_hidden_dim, heads, attention, num_point):
        ...
        if 'local' in self.attention:
            ...
            self.cross_attn = ModifyMultiScaleDeformableAttention(fc_hidden_dim, 1, self.num_feature_levels, num_point, dropout=0.1, im2col_step=64, batch_first=True)
