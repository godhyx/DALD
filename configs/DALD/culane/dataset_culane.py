...
data_root = ["/data/heyuxing/lanedetect/data/CULane", r'/data/heyuxing/CULan/3_4', r'/data/heyuxing/CULan/1_4']
...
train_pipeline = [
    dict(type="albumentation", pipelines=train_al_pipeline, cut_unsorted=False),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        data_list=data_root[0] + "/list/train_gt.txt",
        diff_file=data_root[0] + "/list/train_diffs.npz",
        diff_thr=15,
    ...
    val=dict(
        ...
        data_root=data_root,
        samples_per_gpu=1,
        data_list=[data + "/list/test.txt" for data in data_root],
    ...
    test=dict(
        ...
        samples_per_gpu=24,
        data_root=data_root,
        # data_list=data_root[0] + "/list/test_split/test6_curve.txt",
        data_list=[data + "/list/test.txt" for data in data_root],
        pipeline=val_pipeline,
        test_mode=True,
    ),
